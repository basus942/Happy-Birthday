...
const RECIPIENT_NAME = (import.meta.env.VITE_RECIPIENT_NAME || 'Antara').trim();

// Dynamically populate recipient name across elements from env
if ($('wLine2')) $('wLine2').textContent = RECIPIENT_NAME;
if ($('wHero')) $('wHero').textContent = `Happy Birthday, ${RECIPIENT_NAME}`;
if ($('eyebrow')) $('eyebrow').textContent = `a little something for my love, ${RECIPIENT_NAME}`;
document.title = `Happy Birthday, ${RECIPIENT_NAME} ♥ — a little film`;
